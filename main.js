...
// sfc-script:/Users/a.m.sidorenko/Repositories/obsidian-audio-player/src/components/App.vue?type=script
...
// sfc-script:/Users/a.m.sidorenko/Repositories/obsidian-audio-player/src/components/AudioComment.vue?type=script
...
// sfc-template:/Users/a.m.sidorenko/Repositories/obsidian-audio-player/src/components/AudioComment.vue?type=template
...
var App_default = defineComponent({
  ...
  mounted() {
    ...
    this.$el.addEventListener("seek-to-timestamp", (event) => {
...
// sfc-template:/Users/a.m.sidorenko/Repositories/obsidian-audio-player/src/components/App.vue?type=template
var _hoisted_12 = {
...
var _hoisted_10 = { class: "duration" };
var _hoisted_11 = {
  class: "horiz",
  style: { "margin": "auto" }
};
...
var _hoisted_13 = { class: "comment-list" };
function render2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", _hoisted_12, [
    createBaseVNode("div", _hoisted_22, [
      ...
      createBaseVNode("div", _hoisted_4, [
        ...
        createBaseVNode("div", _hoisted_7, [
          ...
          _ctx.isSticky ? (openBlock(), createElementBlock("span", _hoisted_9, toDisplayString(_ctx.fileName), 1)) : createCommentVNode("v-if", true),
          createBaseVNode("span", _hoisted_10, toDisplayString(_ctx.displayedDuration), 1)
        ])
      ])
    ]),
    ...
    _ctx.showInput ? (openBlock(), createElementBlock("div", _hoisted_122, [
...
// src/audioPlayerView.ts
var import_obsidian4 = require("obsidian");

// sfc-script:/Users/a.m.sidorenko/Repositories/obsidian-audio-player/src/components/SidebarAudioPlayer.vue?type=script
var import_obsidian3 = require("obsidian");
var SidebarAudioPlayer_default = defineComponent({
  ...
  methods: {
    isCurrent() {
      return this.audio && this.audio.src === this.currentFile;
    },
    async loadFile() {
      if (!this.filepath)
        return;
    ...
    setBtnIcon(icon) {
      if (this.button) {
        (0, import_obsidian3.setIcon)(this.button, icon);
      } else {
        this.button = this.$refs.playpause;
        if (this.button) {
          (0, import_obsidian3.setIcon)(this.button, icon);
    ...
    handleSidebarAudioUpdate(event) {
  ...
  mounted() {
    ...
    document.addEventListener("sidebar-audio-update", this.handleSidebarAudioUpdate);
    if (this.audio) {
      this.audio.addEventListener("ended", () => {
        if (this.audio && this.audio.src === this.currentFile) {
          this.setBtnIcon("play");
    ...
    this.updateInterval = setInterval(this.updateAudioState, 100);
  },
  beforeUnmount() {
    ...
    document.removeEventListener("sidebar-audio-update", this.handleSidebarAudioUpdate);
  }
});

// sfc-template:/Users/a.m.sidorenko/Repositories/obsidian-audio-player/src/components/SidebarAudioPlayer.vue?type=template
var _hoisted_14 = { class: "sidebar-audio-player-sb" };
var _hoisted_23 = {
  key: 0,
  class: "no-audio-message-sb"
};
var _hoisted_32 = /* @__PURE__ */ createBaseVNode("div", { class: "icon-sb" }, "\u{1F3B5}", -1);
var _hoisted_42 = /* @__PURE__ */ createBaseVNode("p", null, "No audio file loaded", -1);
var _hoisted_52 = /* @__PURE__ */ createBaseVNode("small", null, "Open a note with an audio player to start", -1);
var _hoisted_62 = [
  _hoisted_32,
  _hoisted_42,
  _hoisted_52
...
var _hoisted_72 = {
  key: 1,
  class: "audio-content-sb"
};
var _hoisted_82 = { class: "audio-header-sb" };
var _hoisted_92 = { class: "file-name-sb" };
var _hoisted_102 = { class: "main-controls-sb" };
var _hoisted_112 = { class: "control-group-sb" };
var _hoisted_123 = { class: "waveform-container-sb" };
var _hoisted_132 = { class: "waveform-sb" };
var _hoisted_142 = ["onMousedown"];
var _hoisted_15 = { class: "timeline-sb" };
var _hoisted_16 = { class: "current-time-sb" };
var _hoisted_17 = { class: "duration-sb" };
var _hoisted_18 = { class: "volume-control-sb" };
var _hoisted_19 = /* @__PURE__ */ createBaseVNode("span", null, "\u{1F50A}", -1);
function render3(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", _hoisted_14, [
    !_ctx.currentFile ? (openBlock(), createElementBlock("div", _hoisted_23, _hoisted_62)) : (openBlock(), createElementBlock("div", _hoisted_72, [
      createBaseVNode("div", _hoisted_82, [
        createBaseVNode("h3", _hoisted_92, toDisplayString(_ctx.fileName), 1)
      ]),
      createBaseVNode("div", _hoisted_102, [
        createBaseVNode("div", _hoisted_112, [
          createBaseVNode("div", {
            class: "playpause-sb seconds-sb",
            onClick: _cache[0] || (_cache[0] = ($event) => _ctx.setPlayheadSecs(_ctx.currentTime - 5))
          }, " -5s "),
          createBaseVNode("div", {
            class: "playpause-sb",
            onClick: _cache[1] || (_cache[1] = (...args) => _ctx.togglePlay && _ctx.togglePlay(...args)),
            ref: "playpause"
          }, null, 512),
          createBaseVNode("div", {
            class: "playpause-sb seconds-sb",
      ...
      createBaseVNode("div", _hoisted_123, [
        createBaseVNode("div", _hoisted_132, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.filteredData, (s, i) => {
            return openBlock(), createElementBlock("div", {
              class: "wv-sb",
              key: _ctx.currentFile + i,
              onMousedown: ($event) => _ctx.barMouseDownHandler(i)
            }, [
              createBaseVNode("div", {
                class: normalizeClass(["wv-bar-sb", { "played-sb": i <= _ctx.currentBar }]),
                style: normalizeStyle({
        ...
        createBaseVNode("div", _hoisted_15, [
          createBaseVNode("span", _hoisted_16, toDisplayString(_ctx.displayedCurrentTime), 1),
          createBaseVNode("span", _hoisted_17, toDisplayString(_ctx.displayedDuration), 1)
        ])
      ]),
      createBaseVNode("div", _hoisted_18, [
        ...
        withDirectives(createBaseVNode("input", {
          type: "range",
          "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => _ctx.volume = $event),
          min: "0",
          max: "1",
          step: "0.1",
          onInput: _cache[4] || (_cache[4] = (...args) => _ctx.updateVolume && _ctx.updateVolume(...args)),
          class: "volume-slider-sb"
        }, null, 544), [
          [vModelText, _ctx.volume]
        ])
      ])
    ]))
  ]);
...
// src/components/SidebarAudioPlayer.vue
SidebarAudioPlayer_default.render = render3;
SidebarAudioPlayer_default.__file = "src/components/SidebarAudioPlayer.vue";
var SidebarAudioPlayer_default2 = SidebarAudioPlayer_default;

// src/audioPlayerView.ts
var AUDIO_PLAYER_VIEW_TYPE = "audio-player-view";
var AudioPlayerView = class extends import_obsidian4.ItemView {
  constructor(leaf, audioElement) {
    super(leaf);
    this.vueApp = null;
  ...
  async onOpen() {
    ...
    this.vueApp = createApp(SidebarAudioPlayer_default2, {
  ...
  updateCurrentFile(filepath, filename, ctx, mdElement) {
...
// src/main.ts
var AudioPlayer = class extends import_obsidian5.Plugin {
  async onload() {
    this.player = document.createElement("audio");
    this.player.volume = 0.5;
    const body = document.getElementsByTagName("body")[0];
    body.appendChild(this.player);
    this.registerView(AUDIO_PLAYER_VIEW_TYPE, (leaf) => new AudioPlayerView(leaf, this.player));
    ...
    this.addCommand({
      ...
      name: "Pause Audio",
      callback: () => {
        new import_obsidian5.Notice("Audio paused");
        const ev = new Event("allpause");
        document.dispatchEvent(ev);
        this.player.pause();
      }
    ...
    this.addCommand({
      ...
      name: "Resume Audio",
      callback: () => {
        new import_obsidian5.Notice("Audio resumed");
        const ev = new Event("allresume");
        document.dispatchEvent(ev);
        if (this.player.src)
          this.player.play();
    ...
    this.registerMarkdownCodeBlockProcessor("audio-player", (source, el, ctx) => {
      ...
      const link = this.app.metadataCache.getFirstLinkpathDest((0, import_obsidian5.getLinkpath)(filename), filename);
  ...
  async toggleAudioPlayerView() {
    ...
    if (existingLeaves.length > 0) {
      ...
      this.app.workspace.revealLeaf(this.app.workspace.getLeavesOfType(AUDIO_PLAYER_VIEW_TYPE)[0]);
    }
  }
  getSidebarView() {
  ...
  handleTimestampClick(event) {
    ...
    if (timestampPattern.test(linkText.trim())) {
      ...
      const audioPlayerElement = this.findNearestAudioPlayer(link);
  ...
  findNearestAudioPlayer(element) {
    let current = element.parentElement;
    while (current) {
      const audioPlayer = current.querySelector(".audio-player-ui");
      if (audioPlayer) {
        return audioPlayer;
      }
      if (current.classList.contains("base-container")) {
        const audioPlayer2 = current.querySelector(".audio-player-ui");
        if (audioPlayer2) {
          return audioPlayer2;
        }
      }
    ...
    return audioPlayers.length > 0 ? audioPlayers[0] : null;
  }
  seekToTimestampInContext(seconds, audioPlayerElement) {
  ...
  seekToTimestamp(seconds) {
    ...
    console.log("Player state:", this.player ? "exists" : "null", ((_a2 = this.player) == null ? void 0 : _a2.src) || "no src");
    if (this.player && this.player.src) {
      ...
      new import_obsidian5.Notice(`Jumped to ${Math.floor(seconds / 60)}:${(seconds % 60).toString().padStart(2, "0")}`);
    } else {
      console.log("Cannot seek - no player or no src");
      new import_obsidian5.Notice("No audio file is currently loaded");
    }
  }
};
